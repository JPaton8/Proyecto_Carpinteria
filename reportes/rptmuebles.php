...
$pdf->SetWidths(array(48,48,30,12,35,25));
...
while ($reg= $rspta->fetch_object()) {
	...
	$pdf->Row(array(utf8_decode($nombre),utf8_decode($categoria),$codigo,$stock,utf8_decode($descripcion),$precio_venta));
}
