...
<div class="panel-body" id="formularioregistros">
  <form action="" name="formulario" id="formulario" method="POST">
    <div class="form-group col-lg-6 col-md-6 col-xs-12">
      ...
      <input class="form-control" type="text" name="nombre" id="nombre" maxlength="100" placeholder="Nombre" pattern="[A-Za-zÁÉÍÓÚáéíóúñÑüÜ\s]+" required>
    </div>
    <div class="form-group col-lg-6 col-md-6 col-xs-12">
...
<div class="panel-body" id="formulario_clave">
  <form action="" name="formularioc" id="formularioc" method="POST">
          <div class="form-group">
            ...
            <input class="form-control" type="password" name="clavec" id="clavec" maxlength="64" placeholder="Nueva clave">
          </div>
