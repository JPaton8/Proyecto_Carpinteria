...
function editar_clave(c){
     ...
     $.ajax({
     	url: "../Controllers/usuario.php?op=editar_clave",
     	type: "POST",
     	data: formData,
     	contentType: false,
     	processData: false,
...
function mostrar(idusuario){
	$.post("../Controllers/usuario.php?op=mostrar",{idusuario : idusuario},
...
function mostrar_clave(idusuario){
	$.post("../Controllers/usuario.php?op=mostrar_clave",{idusuario : idusuario},
		function(data,status)
		{
			data=JSON.parse(data);
			mostrarform_clave(true);
            //$("#clavec").val('Nueva contraseña');
