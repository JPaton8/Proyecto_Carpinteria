...
$.ajax({
url: '../Controllers/negocio.php?op=mostrar_registros',
type:'get',
dataType:'json',
success: function(i){
	 registros=i;
...
function listar(){
	tabla=$('#tbllistado').dataTable({
		...
		"ajax":
		{
			url:'../Controllers/negocio.php?op=listar',
			type: "get",
			dataType : "json",
			error:function(e){
...
function guardaryeditar(e){
     ...
     $.ajax({
     	url: "../Controllers/negocio.php?op=guardaryeditar",
     	type: "POST",
     	data: formData,
     	contentType: false,
     	processData: false,
...
function mostrar(id_negocio){
	$.post("../Controllers/negocio.php?op=mostrar",{id_negocio : id_negocio},
...
function desactivar(id_negocio){
	bootbox.confirm("¿Esta seguro de desactivar este dato?", function(result){
		if (result) {
			$.post("../Controllers/negocio.php?op=desactivar", {id_negocio : id_negocio}, function(e){
				bootbox.alert(e);
				tabla.ajax.reload();
			});
		}
...
function activar(id_negocio){
	bootbox.confirm("¿Esta seguro de activar este dato?" , function(result){
		if (result) {
			$.post("../Controllers/negocio.php?op=activar" , {id_negocio : id_negocio}, function(e){
				bootbox.alert(e);
				tabla.ajax.reload();
			});
		}
