...
<html>
  ...
  <body class="hold-transition login-page" style="background: url('../files/negocio/header1.jpg') no-repeat; background-size: cover;">
    <div id="back"></div>
    <div class="login-box">
      <div class="login-logo">
       <a href="index.html"><b>CARPINTERIA J&J</b></a>
      </div><!-- /.login-logo -->
