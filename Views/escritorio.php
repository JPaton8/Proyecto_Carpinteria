...
if ($_SESSION['escritorio']==1) {
  ...
  $rsptav = $consulta->cantidadmuebles();
  $regv=$rsptav->fetch_object();
  $totalmuebles=$regv->totalar;
...
?>
  <div class="box-header with-border text-center" id="datos_negocio">
    <?php echo "<img src='../files/negocio/".$logo."' height='100px' width='100px' alt=''>"."<img src='../files/negocio/LOGOLETRAS.png"."' height='50px' width='175px' alt=''>" ; ?>
...
<div class="info-box bg-green">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Muebles</span>
              <span class="info-box-number"><?php echo $totalmuebles; ?></span>
