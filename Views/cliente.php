...
<div class="panel-body" style="height: 400px;" id="formularioregistros">
  <form action="" name="formulario" id="formulario" method="POST">
    <div class="form-group col-lg-6 col-md-6 col-xs-12">
      ...
      <input class="form-control" type="text" name="nombre" id="nombre" maxlength="100" placeholder="Nombre del cliente" pattern="[A-Za-zÁÉÍÓÚáéíóúñÑüÜ\s]+" required>
    </div>
     <div class="form-group col-lg-6 col-md-6 col-xs-12">
      <label for="">Tipo Dcumento(*)</label>
     <select class="form-control select-picker" name="tipo_documento" id="tipo_documento" required>
       <option value="NIT">NIT</option>
       <option value="CEDULA">CEDULA IDENTIDAD</option>
     </select>
    </div>
     <div class="form-group col-lg-6 col-md-6 col-xs-12">
