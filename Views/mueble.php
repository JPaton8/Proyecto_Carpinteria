...
<div class="box-header with-border">
  <h1 class="box-title">Mueble <button class="btn btn-success" onclick="mostrarform(true)" id="btnagregar"><i class="fa fa-plus-circle"></i>Agregar</button> <a id="btnreporte" target="_blank" href="../reportes/rptmuebles.php"><button class="btn btn-info">Reporte</button></a></h1>
...
<div class="panel-body" id="formularioregistros">
  <form action="" name="formulario" id="formulario" method="POST">
    <div class="form-group col-lg-6 col-md-6 col-xs-12">
      ...
      <input class="form-control" type="hidden" name="idmueble" id="idmueble">
...
require 'footer.php'
 ...
 <script src="scripts/mueble.js"></script>
