...
<body>
    ...
    <main class="contenedor seccion contenido-centrado">
        ...
        <picture>
            <source srcset="../../public/img/producto1.jpg" type="image/jpg">
            <img loading="lazy" src="../../public/img/producto4.jpg" alt="anuncio">
        </picture>
        <div class="resumen-propiedad">
            <p class="precio">Bs 120</p>
           

            <p>La "Elegancia Circular" destaca por su diseño sofisticado que fusiona la belleza atemporal con la funcionalidad moderna. La forma redonda no solo promueve la conversación fluida, sino que también agrega un toque de elegancia que transforma cualquier comedor en un escenario de refinamiento.</p>
