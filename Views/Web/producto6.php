...
<body>
    ...
    <main class="contenedor seccion contenido-centrado">
        ...
        <picture>
            ...
            <img loading="lazy" src="../../public/img/producto6.jpg" alt="anuncio">
        </picture>
        <div class="resumen-propiedad">
            <p class="precio">Bs 1500</p>
           

            <p>La cama [Nombre del Modelo] presenta un diseño elegante que se adapta a una variedad de estilos de decoración. Sus líneas limpias y detalles cuidadosamente elaborados la convierten en el punto focal perfecto para cualquier habitación.</p>
