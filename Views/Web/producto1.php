...
<body>
    ...
    <main class="contenedor seccion contenido-centrado">
        ...
        <picture>
            ...
            <img loading="lazy" src="../../public/img/producto1.jpg" alt="anuncio">
        </picture>
        <div class="resumen-propiedad">
            <p class="precio">100Bs</p>
           

           <p>El "Harmony" presenta líneas limpias y modernas, complementadas por detalles elegantes. Su diseño contemporáneo se integra fácilmente en una variedad de estilos de decoración, desde lo clásico hasta lo vanguardista.</p>
